            ...
            <div class="hidden lg:block lg:w-80">
                <div class="flex items-center justify-end">
                    <div class="flex">
                        ...
                        <a href="#"
                            class="px-3 py-2 rounded-md text-sm font-medium text-indigo-200 hover:text-white">Domains</a>
                    </div>
                    <!-- Profile dropdown -->
                        ...
                        <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <button type="submit" style="all:unset;">
                                    ...
                                    role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</span>
                                </button>
                            </form>
        ...
        <div class="pt-4 pb-3 border-t border-indigo-800">
            <div class="px-2 space-y-1">
                ...
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <button type="submit" style="all:unset;">
                        <span class="block px-3 py-2 rounded-md text-base font-medium text-indigo-200 hover:text-indigo-100 hover:bg-indigo-600"
                            >Sign out</span>
                    </button>
                </form>
            </div>
